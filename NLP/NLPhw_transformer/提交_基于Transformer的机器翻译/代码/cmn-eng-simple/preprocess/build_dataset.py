...
Index = 4
with open('en_vocab.txt', 'r', encoding='utf-8') as f:
    for line in f:
        line = re.split(' ', line)
...
with open("../word2int_en.json", "w", encoding='utf-8') as f:
    json.dump(word2int_en, f, ensure_ascii=False)

with open("../int2word_en.json", "w", encoding='utf-8') as f:
...
with open("../word2int_cn.json", "w", encoding='utf-8') as f:
    json.dump(word2int_cn, f, ensure_ascii=False)

with open("../int2word_cn.json", "w", encoding='utf-8') as f:
    json.dump(int2word_cn, f, ensure_ascii=False)


en_sentences = []
with open('en_refine.txt', 'r', encoding='utf-8') as f:
