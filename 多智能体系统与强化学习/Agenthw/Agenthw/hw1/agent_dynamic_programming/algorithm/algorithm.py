...
class Algorithm:
    ...
    def _get_value(self, state, action, F, V):
        ...
        try:
            ...
            # Encourage entering treasure cells, while keeping each-step penalty dominant
            # to avoid local "treasure farming" loops.
            # 鼓励走到宝箱格子，同时保持步数惩罚主导，避免刷箱循环
            if next_state in self.treasure_states and next_state != state:
